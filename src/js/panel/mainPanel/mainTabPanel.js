// JavaScript Document
WebChat.Ext.Panel.TabPanel.extend('WebChat.Ext.Panel.MainTabPanel',
{
	...
	tabClick:function(tabElement, event)
	{
		...
		if(!this.friendClazzTable)this.friendClazzTable =  this.units[0].context.children();
		if(!this.groupClazzTable)this.groupClazzTable =  this.units[1].context.children();
